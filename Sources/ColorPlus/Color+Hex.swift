...
public typealias RGBA = (r: Double, g: Double, b: Double, a: Double)
/// Tuple containing HSBA values 0.0-1.0
public typealias HSBA = (h: Double, s: Double, v: Double, a: Double)
